...
export class SendMoneyComponent implements OnInit {
  ...
  handleselectCurrency() {
    // Navigate to the new step instead of selectvouchervalue
  ...
  youPayCurrency: string = 'ZAR'; // Default currency for "You Pay"
  recipientReceivesAmount: number = 0;
  recipientReceivesCurrency: string = 'USD'; // Default currency for "Recipient Receives"
